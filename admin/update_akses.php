<?php $id=$_GET['id'];
    ...
    $q=mysqli_query($kon,"SELECT * FROM user where id_user='$id'");
    $bc=mysqli_fetch_row($q);
 ?>
<form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
  <h1 class="box-title" style="font-size:150%;">Edit User </h1>
</div>
	...
	<div class="box-body"  style="width:99.5%">
      ...
      <tr>
        <div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nm_user" value="<?php echo $bc[1];?>" required></td>
          </div>
      </tr>
      ...
      <tr>
        <div class="form-group">
          ...
          <td><input type="text" class="form-control" name="pswd" value="<?php echo $bc[2];?>" required></td>
          </div>
      </tr>
...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $pswd=$_POST['pswd'];
            ...
            mysqli_query($kon,"UPDATE user set namauser='$usr', passwd='$pswd' WHERE id_user='$id'");
